                ...
                <li class="mb-4 ms-6">
                    ...
                    <h3 class="flex items-center mb-1 text-base">
                        <span>
                            ...
                            @if ($action->remarks && $action->status->minor() && $action->status !== RequestStatus::REASSIGNED)
                    ...
                    @if ($action->remarks && ($action->status->major() || $action->status === RequestStatus::REASSIGNED))
